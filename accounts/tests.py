...
class AuthFlowTests(TestCase):
    ...
    def test_login_success(self):
        User.objects.create_user(username="carol", email="carol@example.com", password="Xx1234567890!!")
        resp = self.client.post(reverse("login"), {"identifier": "carol", "password": "Xx1234567890!!"})
        self.assertEqual(resp.status_code, 302)
    ...
    def test_csrf_required_on_post(self):
        ...
        resp = self.client.post(reverse("login"), {"identifier": "x", "password": "y"}, follow=False)
    ...
    def test_lockout_after_failures(self):
        ...
        User.objects.create_user(username="dave", email="dave@example.com", password="Xx1234567890!!")
    ...
    def test_xss_escaped_in_dashboard(self):
        ...
        u = User.objects.create_user(username="<script>alert('x')</script>", email="x@example.com", password="Xx1234567890!!")
        self.client.post(reverse("login"), {"identifier": "x@example.com", "password": "Xx1234567890!!"})
        resp = self.client.get(reverse("dashboard"))
